        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    @elseif($status->meta_value === 'booked')
                    ...
                    @elseif($status->meta_value === 'declined')
