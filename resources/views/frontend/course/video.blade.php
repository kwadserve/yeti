...
@section('rightSideContent')
    @if (Auth::user()->course_status === 'ongoing')
                ...
                <div class="lesson-top-bar">
                    ...
                    <div class="lesson-top-right">
                        <div class="rbt-btn-close">
                            <a href="{{url('/')}}" title="Go Back to Course" class="rbt-round-btn"><i
                                    class="feather-x"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content">
                        <div class="section-title">
                            ...
                            <p>You are a learning module away from making a difference in India’s youth vote. By becoming a
                                ...
                                register voters on the ECI’s platform, but also gain knowledge of the youth rights movement
                                in
                                India, its importance in the 21st century and learn to speak confidently of these to your
                                peers!
                            </p>

                            <p>Make a difference in India’s youth vote Young India Foundation welcomes you to its first one
                                of
                                kind free course to becoming training facilitators on Youth Rights & Electoral Democracy. We
                                believe that young people have the ability to play a larger role through civic participation
                                and
                                bringing forth change through their actions.</p>

                            <p>This online course named is offered solely online by Young India Foundation's Centre for
                                Youth
                                Policy, but is not equivalent to an on-campus course. It does not confer a University grade,
                                course credits or a degree, and does not hold and/or guarantee affiliation of the recipient
                                with
            ...
            <div class="inner">
                <div class="plyr__video-embed rbtplayer">
                    <video id="course_video" width="100%" preload="true" controls="play" controlsList="nodownload">
                        <source src="{{ URL::asset('/' . $video->location . '#t=' . $videoTime->meta_value) }}"
                            type="video/mp4">
    ...
    @else
        <div class="rbt-lesson-rightsidebar overflow-hidden lesson-video" id="course-video">
            <div class="lesson-top-bar">
                <div class="lesson-top-left">
                    <div class="rbt-lesson-toggle">
                        <button class="lesson-toggle-active btn-round-white-opacity" title="Toggle Sidebar"><i
            ...
            <div class="bg-color-extra2 ptb--15 overflow-hidden">
                <div class="rbt-button-group">
                    <a class="rbt-btn icon-hover btn-md d-none" href="{{ url('schedule') }}" id="next-video">
