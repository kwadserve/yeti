                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <div class="social-links mt-2">
                            <a href="{{App\Http\Controllers\UserController::get_meta($user->id, 'twitter')}}" class="twitter">
                                <i class="bi bi-twitter"></i>
                            </a>
                            <a href="{{App\Http\Controllers\UserController::get_meta($user->id, 'facebook')}}" class="facebook">
                                <i class="bi bi-facebook"></i>
                            </a>
                            <a href="{{App\Http\Controllers\UserController::get_meta($user->id, 'instagram')}}" class="instagram">
                                <i class="bi bi-instagram"></i>
                            </a>
                            <a href="{{App\Http\Controllers\UserController::get_meta($user->id, 'linkedin')}}" class="linkedin">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{App\Http\Controllers\UserController::get_meta($user->id, 'pin')}}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Institute/Place of work</div>
                                    <div class="col-lg-9 col-md-8">{{App\Http\Controllers\UserController::get_meta($user->id, 'institute')}}</div>
                                </div>
                            </div>
